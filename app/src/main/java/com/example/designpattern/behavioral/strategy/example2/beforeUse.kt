...
fun main() {
    val product1 =
        com.example.designpattern.behavioral.strategy.example2.Product1("Laptop", 1000.0, "Regular")
    val product2 = com.example.designpattern.behavioral.strategy.example2.Product1(
        "Smartphone",
        500.0,
        "Premium"
    )
    val product3 = com.example.designpattern.behavioral.strategy.example2.Product1(
        "Headphones",
        50.0,
        "Christmas"
    )
    val product4 = com.example.designpattern.behavioral.strategy.example2.Product1(
        "Camera",
        120.0,
        "BlackFriday"
    )
